<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $target = "D:/ospanel/domains/gallery/".basename($_FILES['image'] ['name']);
...
<title>Catusday: Галерея</title>
</head>
<body>
<header class="main-header">
      <div class="header-container">
    <a class="logotype-link" href="catusday.html"><img src="img/Wink.svg" width="37px" height="35px" class="logotype-img"></a>
    <p class="logotype-text"><a class="logotype-link" href="catusday.html"> Caturday</a> </p>
    <nav class="main-header-nav">
        <ul class="nav-list">
             <li class="nav-item"><a class="nav-active" href="catusday.html"> Главная </a></li>
            <li class="nav-item"><a href="#news">Новости</a></li>
            <li class="nav-item"><a href="#">Галерея</a></li>
        </ul>
    </nav>
    <div class="theme">
    ...
    <div class="hero-container"> 
        <h1> Галерея ваших котиков</h1>
        <p class="hero_p"> Здесь вы можете публиковать фотографии своих хвостатых друзей! Только обязательно пишите их имена!<br> Наша редакция каждую неделю выбирает двух лучших котиков недели по внутреннему голосованию!</p>
    </div>
<div class="content">
  <?php
  $db = mysqli_connect("localhost", "root", "", "photos");
  ...
  <form method="POST" action="index.php" enctype="multipart/form-data">
      ...
      <textarea
      	...
      	rows="4" 
      	name="text" 
      	placeholder="Расскажите нам про своего кота!"></textarea>
  	</div>
  	<div>
  		<button type="submit" name="upload">Опубликовать</button>
  	</div>
  </form>
</div>
